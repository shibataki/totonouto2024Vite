...
const IntroObj: IntroArray = [
	{
		...
		typo: [
			'大阪の八尾にある完全予約制の貸切サウナ。',
			'お時間は1枠150分となります。',
			'2種類のサウナ室を同時にお楽しみいただけます。',
			'プライベートな個室の空間をたっぷりお楽しみください。カップル利用可能です。大阪でのサウナデートにいかがでしょうか。また、サウナ好きのご友人にもぜひぜひご紹介ください。',
			'ととのうとのサウナは水風呂付きになります。',
			'チラーを設置しておりますので、夏でも冷たい水風呂をお楽しみいただけます。',
		],
	},
	{
		alt: 'フタリサウナ',
	...
	},
	{
		...
		typo: [
			...
			'同時に6名様までご利用できる広さのサウナ室になります。プライベートな個室空間をお楽しみください',
			'ご友人同士でお話を楽しんだり、カップルでゆったり過ごしたり、さまざまな入り方でお楽しみいただけます。',
		],
	},
	{
		alt: '野沢の壁',
